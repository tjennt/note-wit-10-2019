  ...
  <body>
        <div id="wrap">
                ...
                <div id="main-content">
                  ...
                  <p>Vui lòng kiểm tra lại liên kết của bạn.</p>
            
                  
            
                  <div id="navigation">
                    <a class="navigation" href="{{ url('/') }}">Trang chủ</a>
                    <a class="navigation" target="target" href="https://www.facebook.com/natriwit">Contact</a>
                  </div>
                </div>
              </div>
    <script>
